# I Need to Reason About What I'm Doing Here
...
In this program, what is important right now is how cyclical types are evaluated at
compile time.
It appears that type evaluation is in someways shallow, to prevent
...
So a shallow type implementation (enough to define `sizeof()`), and a somehow recursive one
...
I'm not so sure might have to check back on this one.

CONSIDER: `typeof(expr)` does not have the same semantics as
