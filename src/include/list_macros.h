...
#define PARENS ()
#define FOREACH_MACRO_H(macro, a, ...) macro(a) \
__VA_OPT__(FOREACH_MACRO_A PARENS (macro, __VA_ARGS__))
#define FOREACH_MACRO_A() FOREACH_MACRO_H
#define FOREACH_MACRO(macro, ...) __VA_OPT__(EXPAND(FOREACH_MACRO_H(macro, __VA_ARGS__)))
...
#define FOREACH_RECURSE_MACRO_H(begin, end, a, ...) begin(a) \
    __VA_OPT__(FOREACH_RECURSE_MACRO_A PARENS (begin, end, __VA_ARGS__)) \
    end(a)
#define FOREACH_RECURSE_MACRO_A() FOREACH_RECURSE_MACRO_H
#define FOREACH_RECURSE_MACRO(begin, end, ...) __VA_OPT__(EXPAND(FOREACH_RECURSE_MACRO_H(begin, end, __VA_ARGS__)))
