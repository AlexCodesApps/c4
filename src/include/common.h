...
typedef struct {
	...
	u32 last_opaque_id;		 // keeps track of the last opaque dependency (like
							 // structs) that enable circular types
	u32 last_fn_id; // keep track of the last const function running (any cycle
